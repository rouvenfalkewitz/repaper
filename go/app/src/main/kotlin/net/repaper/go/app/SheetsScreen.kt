...
/** The Sheets tab — placeholder while the nav is verified; ported next. */
class SheetsScreen(private val c: AppCompatActivity) : Screen {
    override val view: View by lazy {
        ...
        root.addView(Ui.wordmark(c, "Sheets"))
        root.addView(Ui.bodyText(c, "sheets tab", 14f).apply { setPadding(0, dp(16), 0, 0) })
