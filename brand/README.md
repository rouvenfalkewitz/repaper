...
5. **Primary button = Re Green fill + Carbon/Ink text.** On carbon it's the only element that glows. **The wordmark and mark never glow** — flat colour everywhere. Glow is light, never ink: buttons on screen and real light sources only, never type, never print.
